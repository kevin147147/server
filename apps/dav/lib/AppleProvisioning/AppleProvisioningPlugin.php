...
class AppleProvisioningPlugin extends ServerPlugin {
	...
	public function httpGet(RequestInterface $request, ResponseInterface $response) {
		if ($request->getPath() !== AppleProvisioningNode::FILENAME) {
			return true;
		}
...
EOF;
		...
		// TODO - use sprintf to properly replace placeholders in template
		// instead of this template thingy

		$this->server->httpResponse->setStatus(207);
		// TODO use Content disposition cause it's a download, also see export plugin for calendar for refernce
